...
from flask import Flask, jsonify, request  # Import 'request' to get query parameters
import re
import time
...
@app.route("/api/search", methods=['GET'])  # Use angle brackets for route parameters
def get_torrents():
    query = request.args.get('q', '')  # Get 'q' and 'page' query parameters
    page = request.args.get('page', 1)
    my_dict = scrape_bitsearch(query, page)  # Pass query and page parameters
